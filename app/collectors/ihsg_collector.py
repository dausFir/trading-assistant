"""IHSG/Indonesian Stock Collector using yfinance."""
import asyncio
...
# Indonesian stock symbols (some may work with yfinance)
IHSG_SYMBOLS = [
...
class IHSGCollector:
    """Collects Indonesian stock market data using yfinance."""
    ...
    def __init__(
        ...
        """Initialize the IHSG collector.
        
        Args:
            symbols: List of Indonesian stock symbols (default: major IHSG stocks)
            interval_minutes: Update interval in minutes
            max_candles: Maximum candles to store in memory
        """
        self.symbols = symbols or IHSG_SYMBOLS
    ...
    async def fetch_candle(self, symbol: str) -> Optional[Candle]:
        ...
        Args:
            symbol: Indonesian stock symbol
